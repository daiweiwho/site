...
def SaveSinglePage(page_url):
	...
	page_save_path = "website/" + datetime.now().strftime("%Y-%m-%d %H") + "/" + domain_path + "/" + GetUrlPart(processed_page_url, "path")
	...
	for link in links_all:
		...
		try:
			...
			print(e)
			continue
		source_save_path = "website/" + datetime.now().strftime("%Y-%m-%d %H") + "/" + domain_path + "/" + link_info["source_save_path"]
